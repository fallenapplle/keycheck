...
def main():
    ...
    parser.add_argument("--g-map-key", "-key", dest="api_key", help="APi key for google maps", required=True)
    ...
    # add args and des=api key to give key 
    for urls in google_maps_urls:
        check_google_maps(urls, verbose=args.verbose)
